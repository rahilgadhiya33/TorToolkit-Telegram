try:
    ...
    class ExecVars:
        ...
        API_HASH = "a2097f5b3e5365508d7b2aaf669844cb"
        API_ID = 1618029
        BOT_TOKEN = "1981585338:AAEuDoZ5_5g4TXD8uQcY5ZHvft4JPbBfjP4"
        BASE_URL_OF_BOT = "http://3.144.90.107"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [1001196252164]
        OWNER_ID = 747680061
